    ...
    <!-- /.card -->
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Dana</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="/admin/{{$dan->id}}">
                @method('PUT')
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputtext">Sumber Dana</label>
                    <input type="text" name="sumberdana" class="form-control"  value="{{$dan->sumberdana}}"  id="exampleInputtext" placeholder="Sumber Dana">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputjumlah">Jumlah Anggaran</label>
                    <input type="number" name="jumlah" class="form-control" value="{{$dan->jumlah}}" id="exampleInputPassword1" placeholder="Jumlah Anggaran">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputtanggal">Tanggal</label>
                    <input type="date" name="tanggal" class="form-control" value="{{$dan->tanggal}}" id="exampleInputdate">
                  </div>
                <!-- /.card-body -->
